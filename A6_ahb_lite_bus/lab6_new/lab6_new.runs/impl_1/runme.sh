...
HD_PWD='/home/prabhat/COL216/Col216_assignments/A6_ahb_lite_bus/lab6_new/lab6_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buss.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buss.tcl -notrace
