...
HD_PWD='/home/prabhat/COL216/Col216_assignments/A6_ahb_lite_bus/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DC.tcl
