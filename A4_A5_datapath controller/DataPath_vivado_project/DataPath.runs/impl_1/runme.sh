...
HD_PWD='/home/prabhat/COL216/Col216_assignments/A4_A5_datapath controller/DataPath_vivado_project/DataPath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DC.tcl -notrace
