...
set rc [catch {
  ...
  add_files -quiet {{/home/prabhat/COL216/Col216_assignments/A4_A5_datapath controller/DataPath_vivado_project/DataPath.runs/synth_1/DC.dcp}}
...
set rc [catch {
  ...
  catch { write_mem_info -force DC.mmi }
  write_bitstream -force -no_partial_bitfile DC.bit 
  catch { write_sysdef -hwdef DC.hwdef -bitfile DC.bit -meminfo DC.mmi -file DC.sysdef }
