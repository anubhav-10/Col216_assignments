...
begin
    ...
    memo(0) <= "11100011101000000000000000011011";
    --memo(1) <= "11100000100000000000000000000000";
    --memo(2) <= "11100000100000000010000000000001";
    --memo(3) <= "11100000100000100000000000000000";
--    memo(0) <= "11100011";
--    memo(1) <= "00000000";
--    memo(3) <= "00000100";        
